...
// MARK: Generic Extension with Associated type
...
/// This means that you can extend Array to conform to the Container protocol simply by declaring that Array adopts the protocol. You do this with an empty extension
extension Array: Container {}

/// Array’s existing `append(_:)` method and subscript enable Swift to infer the appropriate type to use for Item, just as for the generic Stack type above.
...
/// For example, here’s a protocol that refines the Container protocol,
/// adding the requirement of a `suffix(_:)` method. The `suffix(_:)`
/// method returns a given number of elements from the end of the container, storing them in an instance of the Suffix type
